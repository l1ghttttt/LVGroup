...
const QuestionAnswer = ({title, questionAnswerList}: QuestionAnswerProps) => {
    return (
        <section
            className="px-WebsiteCreatingWelcomePaddingX max-sm:px-[10px] w-full flex flex-col bg-gray-200 items-center relative pb-[100px] pt-[100px] max-lg:pt-[50px] max-sm:pt-[25px] mt-[50px] max-lg:mt-[25px] max-sm:mt-0">
                            ...
                            <AccordionContent>
                                <nav>
                                    <ul className={`duration-1000`} key={component.question}>
                                        <li className={`py-[10px] text-[18px] max-xl:text-[17px] max-md:text-[16px] leading-[24px] text-gray-500`} key={component.answer}>
                                            {component.answer}
                                        </li>
                                    </ul>
                                </nav>
