            ...
            <div className={`xl:flex xl:items-start xl:justify-start flex-col w-OrderedListWidth max-w-[1200px] mt-[150px] xl:[100px] max-md:[50px]`}>
                ...
                <ul>
                    <li className={`website-creating-list-item`}>
                        ...
                        <p className={`block text-[20px] leading-[34px] website-creating-list-item-descr font-railway`}>Определяем
                    ...
                    <li className={`website-creating-list-item`}>
                        ...
                        <p className={`block text-[20px] leading-[34px] website-creating-list-item-descr font-railway`}>Разработка макетов дизайна сайта в четырех форм-факторах (desktop, laptop, tablet, phone) с учетом сценариев поведения пользователей.</p>
                    </li>
                    <li className={`website-creating-list-item`}>
                        <div
                        ...
                        <p className={`block text-[20px] leading-[34px] website-creating-list-item-descr font-railway`}>Пишем чистый валидный оптимизированный код, понятный для третьих лиц. Тестируем все элементы и функционал сайта повторяя пользовательские сценарии.</p>
                    </li>
                    <li className={`website-creating-list-item`}>
                        <div
                        ...
                        <p className={`block text-[20px] leading-[34px] website-creating-list-item-descr font-railway`}>Интегрируем товарные категории (1C, R-keeper, IIko, Excel) или наполняем сайт вручную. Подбираем лаконичный домен, размещаем на скоростном хостинге.</p>
                    </li>
                    <li className={`website-creating-list-item`}>
                        <div
                        ...
                        <p className={`block text-[20px] leading-[34px] website-creating-list-item-descr font-railway`}>Ввод в эксплуатацию, подключение сервисов аналитики, определение путей продвижения: Контекстная реклама, SEO-продвижение, таргетированная реклама. А также занимаемся поддержкой сайта.</p>
                    </li>
                </ul>
            </div>
        </section>
