                ...
                <div
                        ...
                        <div className={`flex flex-col gap-[5px] justify-start leading-[34px] text-[21px]`}>
                            ...
                            <ul className={`flex flex-col gap-[5px] `}>
                                ...
                                <li className={`pl-[25px] relative customerList `}><p className={`my-[20px]`}>Помимо
                                    кнопок &quot;записаться&quot; должны быть кликабельные кнопки Whats app, выдержанные в
                    ...
                    <div className={`w-full flex flex-col gap-[25px] mt-[100px] max-lg:mt-[50px] items-start`}>
                        ...
                        <p className={`w-3/4 text-[22px] max-md:w-full`}><span
                            ...
                            созданием сайта в компанию &quot;LVGroup&quot;. Ребята отнеслись креативно, с подходом и душой. Все
