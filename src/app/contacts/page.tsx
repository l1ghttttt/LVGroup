        ...
        <main className={`relative max-w-full w-full`}>
            <section className="bg-cover bg-no-repeat">
                ...
                <div
                    ...
                    <div
                        className={`shrink-0 ${theme == "dark" ? "bg-[rgba(4,8,10,.5)]" : "bg-[rgba(184,184,184,.5)]"} ml-[1px] mb-[1px] relative overflow-hidden duration-500 transition-all w-ContactsCubeWidth h-ContactsCubeHeight ${theme == "dark" ? "hover:bg-[#262626]" : "hover:bg-[#d1d1d1]"}`}>
                        <div
