                ...
                <div className=" mb-CustomerTitleMargin flex flex-col">
                    <div className={`p-servicesTitlePadding`}>
                        <div className={`flex justify-between`}>
                            <h2 className={`max-sm:w-full text-customerTitleSize leading-customerTitleLeading`}>Обзвон-информирование граждан
                        ...
                        <div className={`w-full flex gap-[30px] mt-[45px] max-lg:gap-[20px] max-lg:mt-[20px] items-start justify-center flex-col`}>
                            ...
                            <div className={`flex flex-col gap-[5px] justify-start leading-[34px] text-[21px] max-md:text-[17px] max-md:leading-[30px]`}>
                                <ul className={`flex flex-col gap-[5px] `}>
                                    ...
                                    <li className={`pl-[25px] relative customerList `}><p
                                        className={`my-[20px]`}>Помимо переданных отчетов мы также предоставили заказчику несколько наших «эталонных» записей разговоров и свои коррективы скрипта для дальнейшего и еще более эффективного обзвона баз избирателей собственными силами партии.</p></li>
                                    <li className={`pl-[25px] relative customerList `}><p
                                        className={`my-[20px]`}>Хотелось бы также отметить, что мы абсолютно нейтрально относимся к вопросам политики и работаем с любой партией, если конечно их действия не противоречат нашему законодательству :)</p></li>
                                    <li className={`pl-[25px] relative customerList `}><p
