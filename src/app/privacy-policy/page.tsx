    ...
    return (
        <>
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div
                    className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 overflow-y-auto text-[#374151] prose-sm sm:prose-base">
                    <h2>1. ОБЩИЕ ПОЛОЖЕНИЯ</h2>
                    <p>Настоящая политика обработки персональных данных разработана в соответствии с требованиями
                        ...
                        персональных данных, предпринимаемые Индивидуальным предпринимателем Леоновым Борисом
                        Сергеевичем
                        (ИНН: 272198675371, ОГРНИП: 321272400043890) (далее — Оператор).</p>
                    ...
                    <p>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и
                        баз
                        данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://grouplv.ru</p>
                    ...
                    <p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или
                        определяемому Пользователю веб-сайта https://grouplv.ru</p>
                    ...
                    <p>2.10. Пользователь — любой посетитель веб-сайта https://grouplv.ru</p>
                    ...
                    <p>5.7. Хранение персональных данных осуществляется в форме, позволяющей определить субъекта
                        ...
                        хранения персональных данных не установлен федеральным законом, договором, стороной которой,
                    ...
                    <h2>6. ЦЕЛИ И ВИДЫ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
                    <p><strong>Цель обработки</strong></p>
                    <ul>
                        <li>информирование Пользователя о товарах, услугах, деятельности Оператора посредством отправки
                            электронных писем, звонков, отправки сообщений в мессенджеры;
                        </li>
                    ...
                    <p><strong>Персональные данные:</strong> ФИО, номер телефона, данные cookie и IP-адрес для
                        аналитической
                        статистики посещений сайта.</p>
                    <p>Все указанные данные именуются далее «Персональные данные».</p>
                    <p><strong>Виды обработки персональных данных</strong></p>
                    <p>Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных
                        данных</p>
                    ...
                    <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их
                        ...
                        bsleonov@gmail.com с пометкой «Актуализация персональных данных».</p>
                    <p>8.4. Срок хранения персональных данных составляет три года с момента последнего обращения
                        Пользователя, если иной срок не предусмотрен договором или действующим законодательством.</p>
                    <p>Пользователь вправе в любое время отозвать своё согласие на обработку персональных данных,
                        отправив
                        соответствующее уведомление на электронную почту Оператора bsleonov@gmail.com с темой письма
                        «Отзыв
                    ...
                    <p>11.1. Связаться с администрацией сайта по вопросам обработки персональных данных можно по
                        электронной
                        почте bsleonov@gmail.com</p>
                    <p>11.2. В данном документе будут отражены любые изменения политики обработки персональных данных
