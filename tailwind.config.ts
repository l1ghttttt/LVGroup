  	...
  	extend: {
		...
		borderColor: {
  		...
  		padding: {
			...
			BlogWelcomePaddingBottom: 'var(--blog-welcome-padding-bottom)',
			BlogWelcomePaddingTop: 'var(--blog-welcome-padding-top)',
			BlogWelcomePaddingX: 'var(--blog-welcome-padding-x)',
  		...
  		margin: {
			...
			BlogWelcomeDescrMarginTop: 'var(--blog-welcome-descr-margin-top)',
